...
namespace enemy
{
    Peasant_Enemy::Peasant_Enemy(Vector2 start_position)
            : Melee_Enemy(start_position, "Bauer",
                          ...
                          game::Config::melee_enemy_1_hit_frame_count,game::Config::melee_enemy_1_hit_frame_count / game::Config::melee_enemy_1_hit_anim_duration,
                          game::Config::melee_enemy_1_hit_anim_duration)
    {}
}
